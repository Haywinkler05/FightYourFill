...
public class Slot : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler  //If for somereason this doesn't work make sure you choose "implement interface" in potential fixes
{
